    ...
    <div className="mx-auto max-w-6xl">
      ...
      <div className="grid gap-6 lg:grid-cols-[2fr_1fr]">
            ...
            {calendarDays.map((cell, index) => {
              ...
              return (
                <button
                  ...
                  className={`relative aspect-square overflow-hidden border-r border-b border-green-500/30 p-2 sm:p-3 text-left transition ${
                    isSelected
                ...
                >
                  ...
                  <span className="flex h-6 w-6 items-center justify-center rounded-full bg-green-500 text-black text-xs font-bold shadow-[0_0_6px_#22c55e]">
                       {cell.day}
                  </span>
                  ) : (
                  <span
        ...
        <div className="rounded-2xl border border-green-500/50 bg-zinc-950 p-5 shadow-[0_0_12px_rgba(34,197,94,0.15)]">
          <h2 className="text-lg font-semibold text-white">Jour sélectionné</h2>
